...
if (~isempty(handles.tlCameraSDK))
    ...
    if (~strcmp(selectedSerial, 'No camera found'))
        ...
        if(handles.tlCamera.GetIsOperationModeSupported(Thorlabs.TSI.TLCameraInterfaces.OperationMode.HardwareTriggered))                    
            ...
            set(handles.PanelTriggerSettings,'Visible', 'off');
            set(handles.PanelTriggerPolarity,'Visible', 'off');
        end
